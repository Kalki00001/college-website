...
@section('content')
<!-- Page Header -->
<section class="bg-gradient-to-r from-blue-600 to-palepink-600 text-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            <h1 class="text-4xl md:text-black font-bold mb-4">About Our Department</h1>
            <p class="text-xl text-black">Excellence in Computer Science Education & Research</p>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <p class="text-gray-600 mb-6 leading-relaxed">
                    The Department of Data Science was established in 2025 with a vision to provide world-class education 
                ...
                <p class="text-gray-600 mb-6 leading-relaxed">
                    Our department is committed to fostering innovation, creativity, and critical thinking among our students. 
                    We provide a comprehensive education that combines theoretical knowledge with practical skills, preparing 
                    our graduates to excel in the rapidly evolving field of computer science.
                </p>
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="{{ route('department.hod-message') }}" class="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition duration-300">
                        HoD's Message
                    </a>
                    <a href="{{ route('department.vision-mission') }}" class="border-2 border-blue-600 text-blue-600 px-6 py-3 rounded-lg font-semibold hover:bg-blue-600 hover:text-white transition duration-300">
                        Vision & Mission
                    </a>
                </div>
            </div>
            <div class="relative">
                <div class="w-full h-96 bg-gradient-to-br from-blue-100 to-purple-100 rounded-xl flex items-center justify-center">
                    <img src="{{ asset('images/gmu.jpeg') }}" alt="Our University" class="w-full h-full object-cover rounded-xl shadow-lg">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="text-center">
                ...
                <p class="text-gray-600">Our curriculum is designed to meet industry standards and prepare students for real-world challenges.</p>
            </div>
            <div class="text-center">
                ...
                <p class="text-gray-600">We conduct groundbreaking research in AI, machine learning, cybersecurity, and software engineering.</p>
            </div>
            <div class="text-center">
                ...
                <p class="text-gray-600">Our faculty members are industry experts with extensive experience in academia and research.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <p class="text-gray-600 text-sm">5+ modern computer laboratories with latest hardware</p>
            </div>
            <div class="bg-white p-6 rounded-xl shadow-lg text-center">
