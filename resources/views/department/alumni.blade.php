...
<section class="bg-gradient-to-r from-blue-400 to-palepink-600 text-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            <h1 class="text-4xl md:text-black font-bold mb-4">Alumni Network</h1>
            <p class="text-xl text-black">Connecting Past, Present, and Future</p>
        </div>
    </div>
</section>
...
<!-- Alumni Statistics -->
<section id="alumni-stats" class="py-16 bg-white/60">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
<section id="success-stories" class="py-16 bg-white/80">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
