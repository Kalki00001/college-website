...
<section class="bg-gradient-to-r from-blue-400 to-palepink-600 text-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            <h1 class="text-4xl md:text-black font-bold mb-4">Placement Activities</h1>
            <p class="text-xl text-black">Building Careers in Technology</p>
        </div>
    </div>
</section>
...
<!-- Placement Statistics -->
<section id="placement-stats" class="py-16 bg-gray-50/80">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
<!-- Top Recruiters -->
<section id="recruiters" class="py-16 bg-gray-50/80">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
