...
<section class="relative bg-fixed bg-cover bg-center bg-no-repeat text-white min-h-[600px]" 
         style="background-image: url('{{ asset('images/gmu.jpeg') }}');">
    <div class="bg-black/50 min-h-[750px] flex items-center"> <!-- overlay for readability and vertical centering -->
        <div class="w-full">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center tilt"> <!-- Tilt effect wrapper -->
                    
                    <!-- Floating Title -->
                    <h1 class="text-4xl md:text-6xl font-bold mb-6" data-aos="none">
                        Department of Data Science
                    </h1>
                    <p class="text-xl md:text-2xl mb-8 text-blue-100" data-aos="none">
