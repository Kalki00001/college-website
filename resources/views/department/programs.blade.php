...
<section class="bg-gradient-to-r from-blue-600 to-palepink-600 text-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            <h1 class="text-4xl md:text-black font-bold mb-4">Programs & Courses</h1>
            <p class="text-xl text-black">Comprehensive Computer Science Education</p>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg border border-gray-200 card-hover">
                <div class="flex items-center mb-6">
                    ...
                    <div>
                        <h3 class="text-2xl font-bold text-gray-900">Bachelor of Computer Science</h3>
                ...
                <div class="mb-6">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <span class="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm">Software Engineering</span>
                ...
                <div class="flex justify-between items-center">
                    ...
                    <a href="{{ route('department.admission') }}" class="bg-blue-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-blue-700 transition duration-300">
                        Apply Now
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg border border-gray-200 card-hover">
                ...
                <div class="mb-6">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm">Project Management</span>
                        ...
                        <span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm">System Architecture</span>
                    </div>
                </div>
                <div class="flex justify-between items-center">
                    <div class="text-sm text-gray-600">
                    ...
                    <a href="{{ route('department.admission') }}" class="bg-green-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-green-700 transition duration-300">
                        Apply Now
                    </a>
                </div>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg border border-gray-200 card-hover">
                ...
                <a href="{{ route('department.admission') }}" class="w-full bg-purple-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-purple-700 transition duration-300 text-center block">
                    Apply Now
                </a>
            </div>
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg border border-gray-200 card-hover">
                ...
                <a href="{{ route('department.admission') }}" class="w-full bg-red-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-red-700 transition duration-300 text-center block">
                    Apply Now
                </a>
            </div>
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg border border-gray-200 card-hover">
                ...
                <a href="{{ route('department.admission') }}" class="w-full bg-indigo-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-indigo-700 transition duration-300 text-center block">
                    Apply Now
                </a>
            </div>
        </div>
