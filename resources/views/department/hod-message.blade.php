...
<section class="bg-gradient-to-r from-blue-400 to-palepink-600 text-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            <h1 class="text-4xl md:text-5xl font-bold mb-4 "style="color: #3224fbff;">Head of Department's Message</h1>
            ...
            <div class="lg:col-span-1">
                <div class="bg-gray-50 p-8 rounded-xl">
                    <div class="text-center">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-2">Mr. Firoz khan </h3>
                        <p class="text-blue-600 font-semibold mb-4">Head of Department</p>
                        <p class="text-gray-600 text-sm mb-6">
                           Asst. Professor of Data science<br>
                            Ph.D.(persuing)<br>
                            16+ years of experience
                        </p>
                        <div class="space-y-2 text-sm text-gray-600">
                            <p><i class="fas fa-envelope mr-2"></i>firozk@gmit.ac.in</p>
            ...
            <div class="lg:col-span-2">
                <div class="prose prose-lg max-w-none">
                    ...
                    <p class="text-gray-600 mb-6 leading-relaxed">
                        It gives me immense pleasure to welcome you to the Department of Computer Science. 
                        As we navigate through the digital age, computer science has become the backbone 
                    ...
                    <p class="text-gray-600 mb-6 leading-relaxed">
                        ...
                        computer science education. Our faculty members are not just educators but also 
                    ...
                    <div class="bg-blue-50 p-6 rounded-lg border-l-4 border-blue-600">
                        ...
                        <p class="text-right text-gray-600 mt-4 font-semibold">-Mr Firoz khan, HoD</p>
                    </div>
                </div>
            </div>
        </div>
