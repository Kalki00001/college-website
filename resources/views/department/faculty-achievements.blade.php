        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="#awards-recognitions" class="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition duration-300">
                        Awards & Recognitions
                    </a>
                    <a href="#research-achievements" class="border-2 border-blue-600 text-blue-600 px-6 py-3 rounded-lg font-semibold hover:bg-blue-600 hover:text-white transition duration-300">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <p class="text-gray-600 mb-4">
                            Recognized for outstanding contributions to artificial intelligence and machine learning research. 
...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-600 text-lg max-w-3xl mx-auto">
                Our faculty members are recognized by industry leaders for their contributions to technology and innovation.
            </p>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('department.faculty') }}" class="bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-700 transition duration-300">
                    <i class="fas fa-users mr-2"></i>View Faculty Profiles
                </a>
                <a href="mailto:faculty@university.edu" class="border-2 border-blue-600 text-blue-600 px-8 py-3 rounded-lg font-semibold hover:bg-blue-600 hover:text-white transition duration-300">
